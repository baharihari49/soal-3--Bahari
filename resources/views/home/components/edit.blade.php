        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="/" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        <img src="https://res.cloudinary.com/du0tz73ma/image/upload/v1700279273/building_z7thy7.png"
                            class="aspect-square mb-2" alt="">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <select id="category" name="category"
                                ...
                                <option value="TV">Category 1</option>
                                <option value="PC">Category 2</option>
                                <option value="GA">Category 3</option>
                            </select>
                        </div>
                    </div>
                </div>
